...
class ModelSaverBase(object):
    ...
    * `_rm_checkpoint
    ...
    def save(self, step, stats, moving_average=None):
        ...
        chkpt, chkpt_name = self._save(step, save_model, stats)
...
class ModelSaver(ModelSaverBase):
    ...
    def _save(self, step, model, stats):
        ...
        saved_model_name = "%s_step_%d_ppl_%.3f_acc_%.3f.pt" % (self.base_path, step, stats.ppl(), stats.accuracy())
        logger.info("Saving checkpoint " + saved_model_name)
