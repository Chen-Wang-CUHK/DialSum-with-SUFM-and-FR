...
from onmt.modules.global_attention_plus import GlobalAttentionPlus
from onmt.modules.seq_hre_word_global_attention import SeqHREWordGlobalAttention
...
__all__ = ["Elementwise", "context_gate_factory", "ContextGate",
           "GlobalAttention", "GlobalAttentionPlus", "SeqHREWordGlobalAttention", "ConvMultiStepAttention",
