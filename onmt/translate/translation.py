...
class TranslationBuilder(object):
    ...
    def _build_target_tokens(self, src, src_vocab, src_raw, pred, attn):
        ...
        for tok in pred:
            ...
            # add 'tokens[-1] == tgt_field.pad_token' by wchen
            # to 'fix' the decoding bug which may output many padding token at the end of the seq
            if tokens[-1] == tgt_field.eos_token or tokens[-1] == tgt_field.pad_token:
                tokens = tokens[:-1]
                break
